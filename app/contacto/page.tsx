...
export default function Contacto() {
  ...
  return <CorporatePage>
    <section className="contact-hero"><div className="container contact-layout"><div className="contact-intro"><div className="eyebrow light">Contacto</div><h1>Conversemos sobre tu próximo proyecto.</h1><p>Solicita información sobre Avanti, Senderos de Suramérica o nuestros servicios de gerencia de proyectos.</p><div className="contact-data"><div><small>LÍNEAS DE ATENCIÓN</small><a href="tel:+573127770990">+57 312 777 0990</a></div><div><small>CORREOS</small><a href="mailto:avanti@promotorasenderos.com">avanti@promotorasenderos.com</a><a href="mailto:ventas@promotorasenderos.com">ventas@promotorasenderos.com</a></div><div><small>HORARIO AVANTI</small><span>Lun — Dom · 10:00 a.m. — 6:00 p.m.</span></div></div></div>
